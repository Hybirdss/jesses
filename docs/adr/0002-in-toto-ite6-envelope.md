...
- The `jesses.dev` domain hosting the predicate URI is now a stability dependency; documentation and schema served under that path must remain reachable for the lifetime of any attestation claiming conformance to `v0.1`.
